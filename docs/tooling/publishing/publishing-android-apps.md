...
1. Build your project in release mode by running the following command:
...
1. Select your application and go to the **APK** section.
1. Choose *Production*, *Beta* or *Alpha* stage and click the **Upload new APK**.
1. Select the APK produced by the CLI.
