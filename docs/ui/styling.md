...
1. Platform-specific markup blocks (`<ios> ... </ios>`, `<android> ... </android>`)
1. Platform-specific attributes (`<Label ios:style="..." android:style="..."`)
1. Platform-specific CSS rules (`.ios .mystyle { ... }`, `.android .mystyle { ... }`) _[*requires plugin](https://market.nativescript.org/plugins/nativescript-platform-css)_
...
1. `home-common.css`
1. `home.component.ios.css`
1. `home.component.android.css`
